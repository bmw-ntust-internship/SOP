...
- [1. Verify O1 Interface (NETCONF/YANG + VES)](#1-verify-o1-interface-netconfyang--ves)
- [2. Verify E2 Interface (E2AP over SCTP)](#2-verify-e2-interface-e2ap-over-sctp)
- [3. Verify R1 Interface (rApp ↔ Non-RT RIC via DME & SME)](#3-verify-r1-interface-rapp--non-rt-ric-via-dme--sme)
- [4. Verify InfluxDB — PM Data Stored via O1](#4-verify-influxdb--pm-data-stored-via-o1)
- [5. Verify Grafana — PM Data Displayed from InfluxDB via R1](#5-verify-grafana--pm-data-displayed-from-influxdb-via-r1)
